<template>
    <div class="container col-sm-3 col-md-3">
      ...
      <b-form @submit.prevent="onSubmit">
        ...
        <b-button block type="submit" variant="primary" class="mt-3"
          >Entrar</b-button
        >
      </b-form>
    </div>
...
import { BForm, BLink, BFormCheckbox } from "bootstrap-vue";
export default {
  components: { BForm, BLink, BFormCheckbox },
  data() {
    return {
      logoImg,
      user: {
      ...
      options: [
        { value: null, text: "Selecione a unidade" },
  ...
  methods: {
    onSubmit() {
      this.$router.push(`logado/home/${this.user.unidade}/${this.user.matricula}`);
    },
  },
};
</script>
